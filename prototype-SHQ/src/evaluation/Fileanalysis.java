...
public class Fileanalysis {
    public static void main(String[] args) throws OWLOntologyCreationException {
        ...
        String path = "/Users/yue_x/Desktop/科研/IJCAI2021/Data/NCBO BioPortal/owlxml";
        String path1 = "/Users/yue_x/Desktop/TestData";
        File file = new File(path);
        File enddoc = new File("/Users/Desktop/SQ_ontology");
        ...
        for (File f : fs) {
            try {
                ...
                if (!f.isDirectory() && f.getName().endsWith("xml")) {
                    ...
                    if (ontology.getLogicalAxiomCount() <= 10000) {
